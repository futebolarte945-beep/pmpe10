...
import { DispositivoFormatado, LegendaDispositivo } from "../utils/dispositivo";
      ...
      <Reveal>
        <div className="relative overflow-hidden rounded-2xl border border-line bg-ink-2/40">
          ...
          <div className="relative border-b border-line/80 px-6 py-6 md:px-9 md:py-8">
            ...
            <p className="just relative mt-2.5 text-sm leading-relaxed text-fade md:text-[15px]">
              {grupo.contexto}
            </p>
          </div>
            ...
            <div className="relative">
              <div className="paper-box noise relative rounded-lg p-6 pl-8 md:p-8 md:pl-10">
                ...
                <div className="paper-lines">
                  <DispositivoFormatado paragrafos={grupo.dispositivo} />
                </div>
                <LegendaDispositivo />
              </div>
