        ...
        <div>
          <Reveal>
            <div className="flex flex-wrap items-center gap-2">
              <span className="tape-gold inline-flex items-center gap-2 rounded-sm px-3 py-1.5 font-mono text-[10px] font-bold uppercase tracking-[0.24em] text-[#161008]">
                <FileWarning className="h-3.5 w-3.5" /> {config.chipSelo}
              </span>
          ...
          <Reveal delay={170}>
            <div className="mt-6 flex flex-wrap items-center gap-3">
              ...
              <span className="text-sm text-fade">{config.leiComplemento}</span>
            </div>
          </Reveal>

          <Reveal delay={240}>
            <p className="just mt-6 text-[15.5px] leading-relaxed text-paper/70">
              {config.descricao}
            </p>
          </Reveal>
            ...
            <div className="relative -rotate-[1.2deg] overflow-hidden rounded-md border border-line-2 shadow-[0_50px_100px_-30px_rgba(0,0,0,0.9)]">
              ...
              <div className="absolute bottom-5 left-5 right-5 flex items-end justify-between">
                <div>
                  ...
                  <div className="mt-1 font-serif text-xl italic text-paper">{config.quote}</div>
                </div>
